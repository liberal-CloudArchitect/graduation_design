...
echo "[native] GPU_MEMORY_UTILIZATION=$GPU_MEMORY_UTILIZATION VLLM_SERVER_PORT=$VLLM_SERVER_PORT BIND_PORT=$BIND_PORT"
echo "[native] PIPELINE_DEVICE=$PIPELINE_DEVICE MAX_CONCURRENT=$MAX_CONCURRENT MAX_QUEUE_SIZE=$MAX_QUEUE_SIZE"
